...
export default function CoinsQTYPage({portfolio, coins, setCoins, setPortfolio, handleLinkClick}){
      ...
      
    {
      ...
      <section>
        ...
        <div className="btnWrapper">
          <ProgressButton 
            className={coins.filter(coin=>coin.selected===true).every(coin=>coin.qty>0) ? "clickable btn":"notClickable btn"} 
